 ...
 */
export function extractProvinceTables($: any): Array<{ province: string; rows: any[] }> {
 ...
 */
export function reservoirInfoFromTable(rows: any[], province: string, $: any): EmbalsesAndalucia[] {
